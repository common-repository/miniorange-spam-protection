<?php
/** miniOrange enables you to secure your WP websites using miniOrange Spam Protection.
	...
	*/
	...
	function create_customer(){
		...
		$fields = array(
			...
			'areaOfInterest' => 'WP Spam Protection',
	...
	function submit_contact_us( $q_email, $q_phone, $query ) {
		...
		$ch = curl_init($url);
		global $current_user;
		$query = '[WP Spam Protection]: ' . $query;
		$fields = array(
			'firstName'			=> $current_user->user_firstname,
			'lastName'	 		=> $current_user->user_lastname,
	...
	function send_otp_token($auth_type, $phone){
		...
		$fields = array(
			...
			'phone' => $phone,
			'authType' => $auth_type,
			'transactionName' => 'WP Spam Protection'
		);
		$field_string = json_encode($fields);
